...
const LoginPage = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[var(--bg-color)] relative overflow-hidden">
      {/* Ambient glow orbs */}
      <div className="absolute top-[-10%] left-[-10%] w-[400px] h-[400px] bg-[var(--accent-color)] rounded-full blur-[160px] opacity-10 pointer-events-none" />
      <div className="absolute bottom-[-10%] right-[-10%] w-[400px] h-[400px] bg-[var(--accent-color)] rounded-full blur-[160px] opacity-10 pointer-events-none" />
      ...
      <div className="relative z-10 w-full max-w-md px-6">
        ...
        <div className="glass rounded-3xl border border-[var(--border-color)] p-8 shadow-2xl">
          ...
          <p className="mt-6 text-center text-xs text-[var(--text-secondary)]">
            ...
            <Link to="/register" className="text-[var(--accent-color)] hover:underline font-semibold">
              Create one
            </Link>
          </p>
        </div>
